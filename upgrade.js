...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function injectUpgradeUi() {
    ...
    if (studioView && !byId('upgradeHub')) {
      const anchor = byId('wordsetGrid') || byId('managementSummary') || studioView.lastElementChild || studioView.firstElementChild;
  ...
  function bindEvents() {
    byId('openCustomizationBtn')?.addEventListener('click', () => { renderCustomizer(); openModal('customizationModal'); });
    ...
    byId('openPomodoroBtn')?.addEventListener('click', () => { renderPomodoroWidgets(); openModal('pomodoroModal'); });
    byId('openProgressBoosterBtn')?.addEventListener('click', () => { renderPomodoroWidgets(); openModal('pomodoroModal'); });
