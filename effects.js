window.VMUpgradeEffects = (() => {
  ...
  function getEffectConfig(effect) {
    const map = {
      aurora: { countFactor: 18, minCount: 3, baseDuration: 14, minSize: 180, sizeSpread: 160, driftSpread: 56 },
      fireflies: { countFactor: 5.2, minCount: 10, baseDuration: 9.2, minSize: 4, sizeSpread: 10, driftSpread: 34 },
      stardust: { countFactor: 6.4, minCount: 10, baseDuration: 8.4, minSize: 2, sizeSpread: 5, driftSpread: 16 },
      prism: { countFactor: 10, minCount: 6, baseDuration: 7.2, minSize: 24, sizeSpread: 32, driftSpread: 36 },
      comets: { countFactor: 7.5, minCount: 6, baseDuration: 4.6, minSize: 18, sizeSpread: 28, driftSpread: 22 },
      orbs: { countFactor: 8.4, minCount: 6, baseDuration: 10.2, minSize: 18, sizeSpread: 34, driftSpread: 26 },
      bubbles: { countFactor: 7.8, minCount: 7, baseDuration: 9.4, minSize: 12, sizeSpread: 24, driftSpread: 20 },
